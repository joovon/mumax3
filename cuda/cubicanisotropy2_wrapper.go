...
var addcubicanisotropy2_map = map[int]string{0: "",
	...
	86:  addcubicanisotropy2_ptx_86,
	87:  addcubicanisotropy2_ptx_87,
	89:  addcubicanisotropy2_ptx_89,
	90:  addcubicanisotropy2_ptx_90,
	100: addcubicanisotropy2_ptx_100,
	120: addcubicanisotropy2_ptx_120}
...
.visible .entry addcubicanisotropy2(
	.param .u64 .ptr .align 1 addcubicanisotropy2_param_0,
	.param .u64 .ptr .align 1 addcubicanisotropy2_param_1,
	.param .u64 .ptr .align 1 addcubicanisotropy2_param_2,
	.param .u64 .ptr .align 1 addcubicanisotropy2_param_3,
	.param .u64 .ptr .align 1 addcubicanisotropy2_param_4,
	.param .u64 .ptr .align 1 addcubicanisotropy2_param_5,
	.param .u64 .ptr .align 1 addcubicanisotropy2_param_6,
	.param .f32 addcubicanisotropy2_param_7,
	.param .u64 .ptr .align 1 addcubicanisotropy2_param_8,
	.param .f32 addcubicanisotropy2_param_9,
	.param .u64 .ptr .align 1 addcubicanisotropy2_param_10,
	.param .f32 addcubicanisotropy2_param_11,
	.param .u64 .ptr .align 1 addcubicanisotropy2_param_12,
	.param .f32 addcubicanisotropy2_param_13,
	.param .u64 .ptr .align 1 addcubicanisotropy2_param_14,
	.param .f32 addcubicanisotropy2_param_15,
	.param .u64 .ptr .align 1 addcubicanisotropy2_param_16,
	.param .f32 addcubicanisotropy2_param_17,
	.param .u64 .ptr .align 1 addcubicanisotropy2_param_18,
	.param .f32 addcubicanisotropy2_param_19,
	.param .u64 .ptr .align 1 addcubicanisotropy2_param_20,
	.param .f32 addcubicanisotropy2_param_21,
	.param .u64 .ptr .align 1 addcubicanisotropy2_param_22,
	.param .f32 addcubicanisotropy2_param_23,
	.param .u64 .ptr .align 1 addcubicanisotropy2_param_24,
	.param .f32 addcubicanisotropy2_param_25,
	.param .u32 addcubicanisotropy2_param_26
)
{
	...
	ld.param.u64 	%rd4, [addcubicanisotropy2_param_3];
	ld.param.u64 	%rd7, [addcubicanisotropy2_param_6];
	ld.param.f32 	%f171, [addcubicanisotropy2_param_7];
	ld.param.u64 	%rd8, [addcubicanisotropy2_param_8];
	ld.param.f32 	%f172, [addcubicanisotropy2_param_9];
	ld.param.u64 	%rd9, [addcubicanisotropy2_param_10];
	ld.param.f32 	%f173, [addcubicanisotropy2_param_11];
	ld.param.u64 	%rd10, [addcubicanisotropy2_param_12];
	ld.param.f32 	%f174, [addcubicanisotropy2_param_13];
	ld.param.u64 	%rd11, [addcubicanisotropy2_param_14];
	ld.param.f32 	%f175, [addcubicanisotropy2_param_15];
	ld.param.u64 	%rd12, [addcubicanisotropy2_param_16];
	ld.param.f32 	%f176, [addcubicanisotropy2_param_17];
	ld.param.u64 	%rd13, [addcubicanisotropy2_param_18];
	ld.param.f32 	%f177, [addcubicanisotropy2_param_19];
	ld.param.u64 	%rd14, [addcubicanisotropy2_param_20];
	ld.param.f32 	%f178, [addcubicanisotropy2_param_21];
	ld.param.u64 	%rd15, [addcubicanisotropy2_param_22];
	ld.param.f32 	%f179, [addcubicanisotropy2_param_23];
	ld.param.u64 	%rd16, [addcubicanisotropy2_param_24];
	ld.param.f32 	%f180, [addcubicanisotropy2_param_25];
	ld.param.u32 	%r2, [addcubicanisotropy2_param_26];
	mov.u32 	%r3, %ctaid.y;
	mov.u32 	%r4, %nctaid.x;
	mov.u32 	%r5, %ctaid.x;
	...
	mul.f32 	%f171, %f171, %f36;
$L__BB0_3:
	setp.eq.f32 	%p3, %f171, 0f00000000;
	rcp.rn.f32 	%f37, %f171;
	selp.f32 	%f3, 0f00000000, %f37, %p3;
	setp.eq.s64 	%p4, %rd8, 0;
	@%p4 bra 	$L__BB0_5;
	cvta.to.global.u64 	%rd20, %rd8;
	mul.wide.s32 	%rd21, %r1, 4;
...
$L__BB0_13:
	...
	mul.f32 	%f177, %f177, %f43;
$L__BB0_15:
	mul.f32 	%f44, %f176, %f176;
	fma.rn.f32 	%f45, %f175, %f175, %f44;
	fma.rn.f32 	%f46, %f177, %f177, %f45;
	sqrt.rn.f32 	%f47, %f46;
	setp.neu.f32 	%p10, %f47, 0f00000000;
	rcp.rn.f32 	%f48, %f47;
	selp.f32 	%f49, %f48, 0f00000000, %p10;
	mul.f32 	%f17, %f175, %f49;
	mul.f32 	%f18, %f176, %f49;
	mul.f32 	%f19, %f177, %f49;
	setp.eq.s64 	%p11, %rd14, 0;
	@%p11 bra 	$L__BB0_17;
	cvta.to.global.u64 	%rd38, %rd14;
	mul.wide.s32 	%rd39, %r1, 4;
...
$L__BB0_19:
	...
	mul.f32 	%f180, %f180, %f52;
$L__BB0_21:
	ld.param.u64 	%rd64, [addcubicanisotropy2_param_5];
	ld.param.u64 	%rd63, [addcubicanisotropy2_param_4];
	ld.param.u64 	%rd62, [addcubicanisotropy2_param_2];
	ld.param.u64 	%rd61, [addcubicanisotropy2_param_1];
	ld.param.u64 	%rd60, [addcubicanisotropy2_param_0];
	mul.f32 	%f53, %f179, %f179;
	fma.rn.f32 	%f54, %f178, %f178, %f53;
	fma.rn.f32 	%f55, %f180, %f180, %f54;
	sqrt.rn.f32 	%f56, %f55;
	setp.neu.f32 	%p14, %f56, 0f00000000;
	rcp.rn.f32 	%f57, %f56;
	selp.f32 	%f58, %f57, 0f00000000, %p14;
	mul.f32 	%f59, %f178, %f58;
	mul.f32 	%f60, %f179, %f58;
	mul.f32 	%f61, %f180, %f58;
	mul.f32 	%f62, %f18, %f61;
	mul.f32 	%f63, %f19, %f60;
	sub.f32 	%f64, %f62, %f63;
	mul.f32 	%f65, %f19, %f59;
	...
	add.s64 	%rd51, %rd50, %rd48;
	ld.global.nc.f32 	%f72, [%rd51];
	cvta.to.global.u64 	%rd52, %rd64;
	add.s64 	%rd53, %rd52, %rd48;
	ld.global.nc.f32 	%f73, [%rd53];
	mul.f32 	%f74, %f18, %f72;
	fma.rn.f32 	%f75, %f17, %f71, %f74;
	fma.rn.f32 	%f76, %f19, %f73, %f75;
	mul.f32 	%f77, %f72, %f60;
	fma.rn.f32 	%f78, %f71, %f59, %f77;
	fma.rn.f32 	%f79, %f61, %f73, %f78;
	mul.f32 	%f80, %f72, %f67;
	fma.rn.f32 	%f81, %f71, %f64, %f80;
	fma.rn.f32 	%f82, %f73, %f70, %f81;
	mul.f32 	%f83, %f3, %f172;
	mul.f32 	%f84, %f83, 0fC0000000;
	mul.f32 	%f85, %f79, %f79;
	mul.f32 	%f86, %f82, %f82;
	add.f32 	%f87, %f85, %f86;
	mul.f32 	%f88, %f17, %f76;
	...
	mul.f32 	%f97, %f94, %f92;
	mul.f32 	%f98, %f95, %f92;
	fma.rn.f32 	%f99, %f88, %f87, %f96;
	fma.rn.f32 	%f100, %f89, %f87, %f97;
	fma.rn.f32 	%f101, %f90, %f87, %f98;
	add.f32 	%f102, %f91, %f85;
	mul.f32 	%f103, %f64, %f82;
	mul.f32 	%f104, %f67, %f82;
	mul.f32 	%f105, %f70, %f82;
	fma.rn.f32 	%f106, %f102, %f103, %f99;
	fma.rn.f32 	%f107, %f102, %f104, %f100;
	fma.rn.f32 	%f108, %f102, %f105, %f101;
	mul.f32 	%f109, %f84, %f106;
	mul.f32 	%f110, %f84, %f107;
	mul.f32 	%f111, %f84, %f108;
	mul.f32 	%f112, %f3, %f173;
	fma.rn.f32 	%f113, %f3, %f173, %f112;
	mul.f32 	%f114, %f85, %f86;
	mul.f32 	%f115, %f91, %f86;
	mul.f32 	%f116, %f93, %f115;
	mul.f32 	%f117, %f94, %f115;
	mul.f32 	%f118, %f95, %f115;
	fma.rn.f32 	%f119, %f88, %f114, %f116;
	fma.rn.f32 	%f120, %f89, %f114, %f117;
	fma.rn.f32 	%f121, %f90, %f114, %f118;
	mul.f32 	%f122, %f91, %f85;
	fma.rn.f32 	%f123, %f122, %f103, %f119;
	fma.rn.f32 	%f124, %f122, %f104, %f120;
	fma.rn.f32 	%f125, %f122, %f105, %f121;
	mul.f32 	%f126, %f113, %f123;
	mul.f32 	%f127, %f113, %f124;
	mul.f32 	%f128, %f113, %f125;
	sub.f32 	%f129, %f109, %f126;
	sub.f32 	%f130, %f110, %f127;
	sub.f32 	%f131, %f111, %f128;
	mul.f32 	%f132, %f10, 0f40800000;
	mul.f32 	%f133, %f85, %f85;
	mul.f32 	%f134, %f86, %f86;
	add.f32 	%f135, %f133, %f134;
	mul.f32 	%f136, %f76, %f91;
	mul.f32 	%f137, %f17, %f136;
	mul.f32 	%f138, %f18, %f136;
	mul.f32 	%f139, %f19, %f136;
	fma.rn.f32 	%f140, %f91, %f91, %f134;
	mul.f32 	%f141, %f79, %f85;
	mul.f32 	%f142, %f59, %f141;
	mul.f32 	%f143, %f60, %f141;
	mul.f32 	%f144, %f61, %f141;
	mul.f32 	%f145, %f142, %f140;
	mul.f32 	%f146, %f143, %f140;
	mul.f32 	%f147, %f144, %f140;
	fma.rn.f32 	%f148, %f137, %f135, %f145;
	fma.rn.f32 	%f149, %f138, %f135, %f146;
	fma.rn.f32 	%f150, %f139, %f135, %f147;
	fma.rn.f32 	%f151, %f91, %f91, %f133;
	mul.f32 	%f152, %f82, %f86;
	mul.f32 	%f153, %f64, %f152;
	mul.f32 	%f154, %f67, %f152;
	mul.f32 	%f155, %f70, %f152;
	fma.rn.f32 	%f156, %f151, %f153, %f148;
	fma.rn.f32 	%f157, %f151, %f154, %f149;
	fma.rn.f32 	%f158, %f151, %f155, %f150;
	mul.f32 	%f159, %f132, %f156;
	mul.f32 	%f160, %f132, %f157;
	mul.f32 	%f161, %f132, %f158;
	sub.f32 	%f162, %f129, %f159;
	sub.f32 	%f163, %f130, %f160;
	sub.f32 	%f164, %f131, %f161;
	cvta.to.global.u64 	%rd54, %rd60;
	add.s64 	%rd55, %rd54, %rd48;
	ld.global.f32 	%f165, [%rd55];
	add.f32 	%f166, %f165, %f162;
	st.global.f32 	[%rd55], %f166;
	cvta.to.global.u64 	%rd56, %rd61;
	add.s64 	%rd57, %rd56, %rd48;
	ld.global.f32 	%f167, [%rd57];
	add.f32 	%f168, %f167, %f163;
	st.global.f32 	[%rd57], %f168;
	cvta.to.global.u64 	%rd58, %rd62;
	add.s64 	%rd59, %rd58, %rd48;
	ld.global.f32 	%f169, [%rd59];
	add.f32 	%f170, %f169, %f164;
	st.global.f32 	[%rd59], %f170;
$L__BB0_22:
	ret;

}
`
	addcubicanisotropy2_ptx_120 = `
.version 8.8
.target sm_120
.address_size 64
