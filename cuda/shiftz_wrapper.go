...
.visible .entry shiftz(
	.param .u64 .ptr .align 1 shiftz_param_0,
	.param .u64 .ptr .align 1 shiftz_param_1,
	.param .u32 shiftz_param_2,
	.param .u32 shiftz_param_3,
	.param .u32 shiftz_param_4,
	.param .u32 shiftz_param_5,
...
)
{
	...
	ld.param.u64 	%rd2, [shiftz_param_1];
	ld.param.u32 	%r5, [shiftz_param_2];
	ld.param.u32 	%r9, [shiftz_param_3];
	ld.param.u32 	%r10, [shiftz_param_4];
	ld.param.u32 	%r8, [shiftz_param_5];
	ld.param.f32 	%f5, [shiftz_param_6];
	ld.param.f32 	%f4, [shiftz_param_7];
	mov.u32 	%r11, %ctaid.x;
	...
	or.pred  	%p3, %p1, %p2;
	setp.ge.s32 	%p4, %r21, %r10;
	or.pred  	%p5, %p3, %p4;
	@%p5 bra 	$L__BB0_5;
	sub.s32 	%r4, %r21, %r8;
	setp.lt.s32 	%p6, %r4, 0;
	@%p6 bra 	$L__BB0_4;
	setp.ge.u32 	%p7, %r4, %r10;
	mov.f32 	%f5, %f4;
	@%p7 bra 	$L__BB0_4;
	mad.lo.s32 	%r22, %r4, %r9, %r17;
