...
var lltorque2_map = map[int]string{0: "",
	...
	89:  lltorque2_ptx_89,
	90:  lltorque2_ptx_90,
	100: lltorque2_ptx_100,
	120: lltorque2_ptx_120}
...
.visible .entry lltorque2(
	.param .u64 .ptr .align 1 lltorque2_param_0,
	.param .u64 .ptr .align 1 lltorque2_param_1,
	.param .u64 .ptr .align 1 lltorque2_param_2,
	.param .u64 .ptr .align 1 lltorque2_param_3,
	.param .u64 .ptr .align 1 lltorque2_param_4,
	.param .u64 .ptr .align 1 lltorque2_param_5,
	.param .u64 .ptr .align 1 lltorque2_param_6,
	.param .u64 .ptr .align 1 lltorque2_param_7,
	.param .u64 .ptr .align 1 lltorque2_param_8,
	.param .u64 .ptr .align 1 lltorque2_param_9,
	.param .f32 lltorque2_param_10,
	.param .u32 lltorque2_param_11
)
{
	...
	setp.ge.s32 	%p1, %r1, %r2;
	@%p1 bra 	$L__BB0_4;
	ld.param.u64 	%rd37, [lltorque2_param_6];
	cvta.to.global.u64 	%rd12, %rd5;
	...
	add.s64 	%rd23, %rd16, %rd18;
	ld.global.nc.f32 	%f5, [%rd23];
	add.s64 	%rd24, %rd17, %rd18;
	ld.global.nc.f32 	%f6, [%rd24];
	setp.eq.s64 	%p2, %rd11, 0;
	@%p2 bra 	$L__BB0_3;
	cvta.to.global.u64 	%rd25, %rd11;
	...
	mul.f32 	%f38, %f38, %f10;
$L__BB0_3:
	ld.param.u64 	%rd36, [lltorque2_param_2];
	ld.param.u64 	%rd35, [lltorque2_param_0];
	mul.f32 	%f11, %f2, %f6;
	mul.f32 	%f12, %f3, %f5;
	sub.f32 	%f13, %f11, %f12;
	mul.f32 	%f14, %f3, %f4;
