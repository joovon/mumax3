...
var settemperature2_map = map[int]string{0: "",
	...
	100: settemperature2_ptx_100,
	120: settemperature2_ptx_120}
...
.visible .entry settemperature2(
	.param .u64 .ptr .align 1 settemperature2_param_0,
	.param .u64 .ptr .align 1 settemperature2_param_1,
	.param .f32 settemperature2_param_2,
	.param .u64 .ptr .align 1 settemperature2_param_3,
	.param .f32 settemperature2_param_4,
	.param .u64 .ptr .align 1 settemperature2_param_5,
	.param .f32 settemperature2_param_6,
	.param .u64 .ptr .align 1 settemperature2_param_7,
	.param .f32 settemperature2_param_8,
	.param .u32 settemperature2_param_9
)
{
	...
	ld.param.u64 	%rd1, [settemperature2_param_0];
	ld.param.u64 	%rd2, [settemperature2_param_1];
	ld.param.f32 	%f7, [settemperature2_param_2];
	ld.param.u64 	%rd3, [settemperature2_param_3];
	ld.param.f32 	%f22, [settemperature2_param_4];
	ld.param.u64 	%rd4, [settemperature2_param_5];
	ld.param.f32 	%f23, [settemperature2_param_6];
	ld.param.u64 	%rd5, [settemperature2_param_7];
	ld.param.f32 	%f24, [settemperature2_param_8];
	ld.param.u32 	%r2, [settemperature2_param_9];
	mov.u32 	%r3, %ctaid.y;
	mov.u32 	%r4, %nctaid.x;
	mov.u32 	%r5, %ctaid.x;
...
$L__BB0_7:
	...
	mul.f32 	%f16, %f23, %f15;
	rcp.rn.f32 	%f17, %f22;
	setp.eq.f32 	%p5, %f22, 0f00000000;
	selp.f32 	%f18, 0f00000000, %f17, %p5;
	mul.f32 	%f19, %f18, %f16;
	sqrt.rn.f32 	%f20, %f19;
	mul.f32 	%f21, %f14, %f20;
	cvta.to.global.u64 	%rd18, %rd1;
