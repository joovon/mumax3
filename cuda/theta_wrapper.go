...
var setTheta_map = map[int]string{0: "",
	...
	89:  setTheta_ptx_89,
	90:  setTheta_ptx_90,
	100: setTheta_ptx_100,
	120: setTheta_ptx_120}
...
.visible .entry setTheta(
	.param .u64 .ptr .align 1 setTheta_param_0,
	.param .u64 .ptr .align 1 setTheta_param_1,
	.param .u32 setTheta_param_2,
	.param .u32 setTheta_param_3,
	.param .u32 setTheta_param_4
)
{
	...
	ld.param.u64 	%rd2, [setTheta_param_1];
	ld.param.u32 	%r4, [setTheta_param_2];
	ld.param.u32 	%r6, [setTheta_param_3];
	ld.param.u32 	%r7, [setTheta_param_4];
	mov.u32 	%r9, %ctaid.x;
	mov.u32 	%r10, %ntid.x;
	mov.u32 	%r11, %tid.x;
	...
	abs.f32 	%f2, %f1;
	fma.rn.f32 	%f3, %f2, 0fBF000000, 0f3F000000;
	rsqrt.approx.ftz.f32 	%f4, %f3;
	mul.f32 	%f5, %f4, %f3;
	mul.f32 	%f6, %f4, 0fBF000000;
	fma.rn.f32 	%f7, %f5, %f6, 0f3F000000;
	fma.rn.f32 	%f8, %f5, %f7, %f5;
	setp.eq.f32 	%p6, %f2, 0f3F800000;
	selp.f32 	%f9, 0f00000000, %f8, %p6;
	setp.gt.f32 	%p7, %f2, 0f3F0F5C29;
	...
	mov.b32 	%f11, %r25;
	mul.f32 	%f12, %f11, %f11;
	fma.rn.f32 	%f13, %f12, 0f3D10ECEF, 0f3C8B1ABB;
	fma.rn.f32 	%f14, %f13, %f12, 0f3CFC028C;
	fma.rn.f32 	%f15, %f14, %f12, 0f3D372139;
	fma.rn.f32 	%f16, %f15, %f12, 0f3D9993DB;
	fma.rn.f32 	%f17, %f16, %f12, 0f3E2AAAC6;
	mul.f32 	%f18, %f12, %f17;
	fma.rn.f32 	%f19, %f18, %f11, %f11;
	neg.f32 	%f20, %f19;
	selp.f32 	%f21, %f19, %f20, %p7;
	mov.f32 	%f22, 0f3F6EE581;
	fma.rn.f32 	%f23, %f22, 0f3FD774EB, %f21;
	setp.gt.f32 	%p8, %f1, 0f3F0F5C29;
	selp.f32 	%f24, %f19, %f23, %p8;
	add.f32 	%f25, %f24, %f24;
