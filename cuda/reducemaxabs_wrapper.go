...
var reducemaxabs_map = map[int]string{0: "",
	...
	100: reducemaxabs_ptx_100,
	120: reducemaxabs_ptx_120}
...
.visible .entry reducemaxabs(
	.param .u64 .ptr .align 1 reducemaxabs_param_0,
	.param .u64 .ptr .align 1 reducemaxabs_param_1,
	.param .f32 reducemaxabs_param_2,
	.param .u32 reducemaxabs_param_3
)
{
...
$L__BB0_7:
	shl.b32 	%r32, %r1, 2;
	mov.u32 	%r33, _ZZ12reducemaxabsE5sdata;
	add.s32 	%r14, %r33, %r32;
	st.shared.f32 	[%r14], %f50;
	bar.sync 	0;
...
$L__BB0_11:
	...
	atom.global.max.s32 	%r37, [%rd12], %r36;
$L__BB0_14:
	ret;

}
`
	reducemaxabs_ptx_120 = `
.version 8.8
.target sm_120
.address_size 64
