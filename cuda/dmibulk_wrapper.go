...
var adddmibulk_map = map[int]string{0: "",
	...
	100: adddmibulk_ptx_100,
	120: adddmibulk_ptx_120}
...
.visible .entry adddmibulk(
	.param .u64 .ptr .align 1 adddmibulk_param_0,
	.param .u64 .ptr .align 1 adddmibulk_param_1,
	.param .u64 .ptr .align 1 adddmibulk_param_2,
	.param .u64 .ptr .align 1 adddmibulk_param_3,
	.param .u64 .ptr .align 1 adddmibulk_param_4,
	.param .u64 .ptr .align 1 adddmibulk_param_5,
	.param .u64 .ptr .align 1 adddmibulk_param_6,
	.param .f32 adddmibulk_param_7,
	.param .u64 .ptr .align 1 adddmibulk_param_8,
	.param .u64 .ptr .align 1 adddmibulk_param_9,
	.param .u64 .ptr .align 1 adddmibulk_param_10,
	.param .f32 adddmibulk_param_11,
	.param .f32 adddmibulk_param_12,
	.param .f32 adddmibulk_param_13,
	.param .u32 adddmibulk_param_14,
...
)
{
	...
	ld.param.u64 	%rd14, [adddmibulk_param_5];
	ld.param.u64 	%rd11, [adddmibulk_param_6];
	ld.param.f32 	%f326, [adddmibulk_param_7];
	ld.param.u64 	%rd15, [adddmibulk_param_8];
	ld.param.u64 	%rd16, [adddmibulk_param_9];
	ld.param.u64 	%rd17, [adddmibulk_param_10];
	ld.param.f32 	%f145, [adddmibulk_param_11];
	ld.param.f32 	%f146, [adddmibulk_param_12];
	ld.param.f32 	%f147, [adddmibulk_param_13];
	ld.param.u32 	%r30, [adddmibulk_param_14];
	...
	add.s64 	%rd22, %rd3, %rd7;
	ld.global.nc.u8 	%rs19, [%rd22];
	cvt.u16.u8 	%rs1, %rs19;
	mul.f32 	%f148, %f2, %f2;
	fma.rn.f32 	%f149, %f1, %f1, %f148;
	fma.rn.f32 	%f150, %f3, %f3, %f149;
	setp.eq.f32 	%p6, %f150, 0f00000000;
	@%p6 bra 	$L__BB0_72;
	and.b16  	%rs2, %rs17, 1;
	setp.eq.s16 	%p7, %rs2, 0;
	@%p7 bra 	$L__BB0_4;
...
$L__BB0_5:
	...
	add.s64 	%rd24, %rd6, %rd23;
	ld.global.nc.f32 	%f277, [%rd24];
	add.s64 	%rd25, %rd5, %rd23;
	ld.global.nc.f32 	%f276, [%rd25];
	add.s64 	%rd26, %rd4, %rd23;
	ld.global.nc.f32 	%f275, [%rd26];
$L__BB0_7:
	mul.f32 	%f154, %f276, %f276;
	fma.rn.f32 	%f155, %f277, %f277, %f154;
	fma.rn.f32 	%f13, %f275, %f275, %f155;
	setp.eq.f32 	%p11, %f13, 0f00000000;
	mov.u16 	%rs64, %rs1;
	@%p11 bra 	$L__BB0_9;
	cvt.s64.s32 	%rd27, %r9;
	add.s64 	%rd28, %rd3, %rd27;
	ld.global.nc.u8 	%rs20, [%rd28];
	cvt.u16.u8 	%rs64, %rs20;
$L__BB0_9:
	and.b16  	%rs21, %rs1, 255;
	and.b16  	%rs22, %rs64, 255;
	...
	add.s64 	%rd30, %rd2, %rd29;
	ld.global.nc.f32 	%f157, [%rd30];
	add.s64 	%rd31, %rd1, %rd29;
	ld.global.nc.f32 	%f14, [%rd31];
	add.f32 	%f15, %f157, %f157;
	...
	@%p15 bra 	$L__BB0_12;
	neg.f32 	%f158, %f145;
	div.rn.f32 	%f159, %f14, %f15;
	mul.f32 	%f160, %f159, %f158;
	mul.f32 	%f161, %f3, %f160;
	sub.f32 	%f276, %f2, %f161;
	fma.rn.f32 	%f275, %f2, %f160, %f3;
	mov.f32 	%f277, %f1;
$L__BB0_12:
	mul.f32 	%f162, %f145, %f145;
	div.rn.f32 	%f163, %f15, %f162;
	sub.f32 	%f164, %f277, %f1;
	sub.f32 	%f165, %f276, %f2;
	sub.f32 	%f166, %f275, %f3;
	fma.rn.f32 	%f287, %f163, %f164, 0f00000000;
	fma.rn.f32 	%f167, %f163, %f165, 0f00000000;
	fma.rn.f32 	%f168, %f163, %f166, 0f00000000;
	div.rn.f32 	%f169, %f14, %f145;
	mul.f32 	%f170, %f169, %f275;
	sub.f32 	%f288, %f167, %f170;
	fma.rn.f32 	%f289, %f169, %f276, %f168;
$L__BB0_13:
	@%p7 bra 	$L__BB0_15;
	add.s32 	%r57, %r1, 1;
	rem.s32 	%r58, %r57, %r30;
...
$L__BB0_16:
	...
	add.s64 	%rd34, %rd5, %rd32;
	ld.global.nc.f32 	%f285, [%rd34];
	add.s64 	%rd35, %rd4, %rd32;
	ld.global.nc.f32 	%f284, [%rd35];
$L__BB0_18:
	mul.f32 	%f174, %f285, %f285;
	fma.rn.f32 	%f175, %f286, %f286, %f174;
	fma.rn.f32 	%f36, %f284, %f284, %f175;
	setp.eq.f32 	%p20, %f36, 0f00000000;
	mov.u16 	%rs65, %rs1;
	@%p20 bra 	$L__BB0_20;
	cvt.s64.s32 	%rd36, %r13;
	add.s64 	%rd37, %rd3, %rd36;
	ld.global.nc.u8 	%rs27, [%rd37];
	cvt.u16.u8 	%rs65, %rs27;
$L__BB0_20:
	and.b16  	%rs30, %rs1, 255;
	and.b16  	%rs31, %rs65, 255;
	...
	add.f32 	%f38, %f176, %f176;
	and.pred  	%p23, %p20, %p13;
	@%p23 bra 	$L__BB0_24;
	setp.neu.f32 	%p24, %f36, 0f00000000;
	@%p24 bra 	$L__BB0_23;
	div.rn.f32 	%f177, %f37, %f38;
	mul.f32 	%f178, %f145, %f177;
	mul.f32 	%f179, %f3, %f178;
	sub.f32 	%f285, %f2, %f179;
	fma.rn.f32 	%f284, %f2, %f178, %f3;
	mov.f32 	%f286, %f1;
$L__BB0_23:
	mul.f32 	%f180, %f145, %f145;
	div.rn.f32 	%f181, %f38, %f180;
	sub.f32 	%f182, %f286, %f1;
	sub.f32 	%f183, %f285, %f2;
	sub.f32 	%f184, %f284, %f3;
	fma.rn.f32 	%f287, %f181, %f182, %f287;
	fma.rn.f32 	%f185, %f181, %f183, %f288;
	fma.rn.f32 	%f186, %f181, %f184, %f289;
	div.rn.f32 	%f187, %f37, %f145;
	fma.rn.f32 	%f288, %f187, %f284, %f185;
	mul.f32 	%f188, %f187, %f285;
	sub.f32 	%f289, %f186, %f188;
$L__BB0_24:
	and.b16  	%rs7, %rs17, 2;
	setp.eq.s16 	%p25, %rs7, 0;
	@%p25 bra 	$L__BB0_26;
...
$L__BB0_27:
	...
	add.s64 	%rd42, %rd6, %rd41;
	ld.global.nc.f32 	%f295, [%rd42];
	add.s64 	%rd43, %rd5, %rd41;
	ld.global.nc.f32 	%f294, [%rd43];
	add.s64 	%rd44, %rd4, %rd41;
	ld.global.nc.f32 	%f293, [%rd44];
$L__BB0_29:
	mul.f32 	%f192, %f294, %f294;
	fma.rn.f32 	%f193, %f295, %f295, %f192;
	fma.rn.f32 	%f59, %f293, %f293, %f193;
	setp.eq.f32 	%p29, %f59, 0f00000000;
	mov.u16 	%rs66, %rs1;
	@%p29 bra 	$L__BB0_31;
	cvt.s64.s32 	%rd45, %r17;
	add.s64 	%rd46, %rd3, %rd45;
	ld.global.nc.u8 	%rs34, [%rd46];
	cvt.u16.u8 	%rs66, %rs34;
$L__BB0_31:
	and.b16  	%rs37, %rs1, 255;
	and.b16  	%rs38, %rs66, 255;
	...
	add.s64 	%rd48, %rd2, %rd47;
	ld.global.nc.f32 	%f194, [%rd48];
	add.s64 	%rd49, %rd1, %rd47;
	ld.global.nc.f32 	%f60, [%rd49];
	add.f32 	%f61, %f194, %f194;
	and.pred  	%p32, %p29, %p13;
	@%p32 bra 	$L__BB0_35;
	setp.neu.f32 	%p33, %f59, 0f00000000;
	@%p33 bra 	$L__BB0_34;
	neg.f32 	%f195, %f146;
	div.rn.f32 	%f196, %f60, %f61;
	mul.f32 	%f197, %f196, %f195;
	fma.rn.f32 	%f295, %f3, %f197, %f1;
	mul.f32 	%f198, %f1, %f197;
	sub.f32 	%f293, %f3, %f198;
	mov.f32 	%f294, %f2;
$L__BB0_34:
	mul.f32 	%f199, %f146, %f146;
	div.rn.f32 	%f200, %f61, %f199;
	sub.f32 	%f201, %f295, %f1;
	sub.f32 	%f202, %f294, %f2;
	sub.f32 	%f203, %f293, %f3;
	fma.rn.f32 	%f204, %f200, %f201, %f287;
	fma.rn.f32 	%f288, %f200, %f202, %f288;
	fma.rn.f32 	%f205, %f200, %f203, %f289;
	div.rn.f32 	%f206, %f60, %f146;
	fma.rn.f32 	%f287, %f206, %f293, %f204;
	mul.f32 	%f207, %f206, %f295;
	sub.f32 	%f289, %f205, %f207;
$L__BB0_35:
	@%p25 bra 	$L__BB0_37;
	add.s32 	%r78, %r41, 1;
	rem.u32 	%r79, %r78, %r33;
...
$L__BB0_38:
	...
	add.s64 	%rd51, %rd6, %rd50;
	ld.global.nc.f32 	%f304, [%rd51];
	add.s64 	%rd52, %rd5, %rd50;
	ld.global.nc.f32 	%f303, [%rd52];
	add.s64 	%rd53, %rd4, %rd50;
	ld.global.nc.f32 	%f302, [%rd53];
$L__BB0_40:
	mul.f32 	%f211, %f303, %f303;
	fma.rn.f32 	%f212, %f304, %f304, %f211;
	fma.rn.f32 	%f82, %f302, %f302, %f212;
	...
	cvt.u16.u8 	%rs67, %rs41;
$L__BB0_42:
	and.b16  	%rs44, %rs1, 255;
	and.b16  	%rs45, %rs67, 255;
	...
	shr.u32 	%r88, %r87, 1;
	add.s32 	%r89, %r88, %r85;
	mul.wide.u32 	%rd56, %r89, 4;
	add.s64 	%rd57, %rd2, %rd56;
	ld.global.nc.f32 	%f213, [%rd57];
	add.s64 	%rd58, %rd1, %rd56;
	ld.global.nc.f32 	%f83, [%rd58];
	add.f32 	%f84, %f213, %f213;
	and.pred  	%p41, %p38, %p13;
	@%p41 bra 	$L__BB0_46;
	setp.neu.f32 	%p42, %f82, 0f00000000;
	@%p42 bra 	$L__BB0_45;
	div.rn.f32 	%f214, %f83, %f84;
	mul.f32 	%f215, %f146, %f214;
	fma.rn.f32 	%f304, %f3, %f215, %f1;
	mul.f32 	%f216, %f1, %f215;
	sub.f32 	%f302, %f3, %f216;
	mov.f32 	%f303, %f2;
$L__BB0_45:
	mul.f32 	%f217, %f146, %f146;
	div.rn.f32 	%f218, %f84, %f217;
	sub.f32 	%f219, %f304, %f1;
	sub.f32 	%f220, %f303, %f2;
	sub.f32 	%f221, %f302, %f3;
	fma.rn.f32 	%f222, %f218, %f219, %f287;
	fma.rn.f32 	%f288, %f218, %f220, %f288;
	fma.rn.f32 	%f223, %f218, %f221, %f289;
	div.rn.f32 	%f224, %f83, %f146;
	mul.f32 	%f225, %f224, %f302;
	sub.f32 	%f287, %f222, %f225;
	fma.rn.f32 	%f289, %f224, %f304, %f223;
$L__BB0_46:
	setp.eq.s32 	%p44, %r34, 1;
	and.pred  	%p45, %p44, %p13;
	@%p45 bra 	$L__BB0_69;
	and.b16  	%rs12, %rs17, 4;
	setp.eq.s16 	%p46, %rs12, 0;
	@%p46 bra 	$L__BB0_49;
...
$L__BB0_50:
	...
	add.s64 	%rd60, %rd6, %rd59;
	ld.global.nc.f32 	%f313, [%rd60];
	add.s64 	%rd61, %rd5, %rd59;
	ld.global.nc.f32 	%f312, [%rd61];
	add.s64 	%rd62, %rd4, %rd59;
	ld.global.nc.f32 	%f311, [%rd62];
$L__BB0_52:
	mul.f32 	%f229, %f312, %f312;
	fma.rn.f32 	%f230, %f313, %f313, %f229;
	fma.rn.f32 	%f105, %f311, %f311, %f230;
	setp.eq.f32 	%p50, %f105, 0f00000000;
	mov.u16 	%rs68, %rs1;
	@%p50 bra 	$L__BB0_54;
	cvt.s64.s32 	%rd63, %r25;
	add.s64 	%rd64, %rd3, %rd63;
	ld.global.nc.u8 	%rs50, [%rd64];
	cvt.u16.u8 	%rs68, %rs50;
$L__BB0_54:
	and.b16  	%rs53, %rs1, 255;
	and.b16  	%rs54, %rs68, 255;
	min.u16 	%rs55, %rs54, %rs53;
	cvt.u32.u16 	%r95, %rs55;
	max.u16 	%rs56, %rs54, %rs53;
	cvt.u32.u16 	%r96, %rs56;
	mad.lo.s32 	%r97, %r96, %r96, %r96;
	shr.u32 	%r98, %r97, 1;
	add.s32 	%r99, %r98, %r95;
	mul.wide.u32 	%rd65, %r99, 4;
	add.s64 	%rd66, %rd2, %rd65;
	ld.global.nc.f32 	%f231, [%rd66];
	add.s64 	%rd67, %rd1, %rd65;
	ld.global.nc.f32 	%f106, [%rd67];
	add.f32 	%f107, %f231, %f231;
	and.pred  	%p53, %p50, %p13;
	@%p53 bra 	$L__BB0_58;
	setp.neu.f32 	%p54, %f105, 0f00000000;
	@%p54 bra 	$L__BB0_57;
	neg.f32 	%f232, %f147;
	div.rn.f32 	%f233, %f106, %f107;
	mul.f32 	%f234, %f233, %f232;
	mul.f32 	%f235, %f2, %f234;
	sub.f32 	%f313, %f1, %f235;
	fma.rn.f32 	%f312, %f1, %f234, %f2;
	mov.f32 	%f311, %f3;
$L__BB0_57:
	mul.f32 	%f236, %f147, %f147;
	div.rn.f32 	%f237, %f107, %f236;
	sub.f32 	%f238, %f313, %f1;
	sub.f32 	%f239, %f312, %f2;
	sub.f32 	%f240, %f311, %f3;
	fma.rn.f32 	%f241, %f237, %f238, %f287;
	fma.rn.f32 	%f242, %f237, %f239, %f288;
	fma.rn.f32 	%f289, %f237, %f240, %f289;
	div.rn.f32 	%f243, %f106, %f147;
	mul.f32 	%f244, %f243, %f312;
	sub.f32 	%f287, %f241, %f244;
	fma.rn.f32 	%f288, %f243, %f313, %f242;
$L__BB0_58:
	@%p46 bra 	$L__BB0_60;
	add.s32 	%r100, %r45, 1;
...
$L__BB0_61:
	...
	add.s32 	%r106, %r45, 1;
	setp.ge.u32 	%p57, %r106, %r34;
	mov.f32 	%f322, 0f00000000;
	and.pred  	%p58, %p57, %p46;
	mov.f32 	%f321, %f322;
	mov.f32 	%f320, %f322;
	@%p58 bra 	$L__BB0_63;
	mul.wide.s32 	%rd68, %r29, 4;
	add.s64 	%rd69, %rd6, %rd68;
	ld.global.nc.f32 	%f322, [%rd69];
	add.s64 	%rd70, %rd5, %rd68;
	ld.global.nc.f32 	%f321, [%rd70];
	add.s64 	%rd71, %rd4, %rd68;
	ld.global.nc.f32 	%f320, [%rd71];
$L__BB0_63:
	mul.f32 	%f248, %f321, %f321;
	fma.rn.f32 	%f249, %f322, %f322, %f248;
	fma.rn.f32 	%f128, %f320, %f320, %f249;
	setp.eq.f32 	%p59, %f128, 0f00000000;
	mov.u16 	%rs69, %rs1;
	@%p59 bra 	$L__BB0_65;
	cvt.s64.s32 	%rd72, %r29;
	add.s64 	%rd73, %rd3, %rd72;
	ld.global.nc.u8 	%rs57, [%rd73];
	cvt.u16.u8 	%rs69, %rs57;
$L__BB0_65:
	setp.ne.s16 	%p60, %rs18, 0;
	and.b16  	%rs60, %rs1, 255;
	and.b16  	%rs61, %rs69, 255;
	min.u16 	%rs62, %rs61, %rs60;
	cvt.u32.u16 	%r107, %rs62;
	max.u16 	%rs63, %rs61, %rs60;
	cvt.u32.u16 	%r108, %rs63;
	mad.lo.s32 	%r109, %r108, %r108, %r108;
	shr.u32 	%r110, %r109, 1;
	add.s32 	%r111, %r110, %r107;
	mul.wide.u32 	%rd74, %r111, 4;
	add.s64 	%rd75, %rd2, %rd74;
	ld.global.nc.f32 	%f250, [%rd75];
	add.s64 	%rd76, %rd1, %rd74;
	ld.global.nc.f32 	%f129, [%rd76];
	add.f32 	%f130, %f250, %f250;
	setp.eq.f32 	%p61, %f128, 0f00000000;
	and.pred  	%p62, %p61, %p60;
	@%p62 bra 	$L__BB0_69;
	setp.neu.f32 	%p63, %f128, 0f00000000;
	@%p63 bra 	$L__BB0_68;
	div.rn.f32 	%f251, %f129, %f130;
	mul.f32 	%f252, %f147, %f251;
	mul.f32 	%f253, %f2, %f252;
	sub.f32 	%f322, %f1, %f253;
	fma.rn.f32 	%f321, %f1, %f252, %f2;
	mov.f32 	%f320, %f3;
$L__BB0_68:
	mul.f32 	%f254, %f147, %f147;
	div.rn.f32 	%f255, %f130, %f254;
	sub.f32 	%f256, %f322, %f1;
	sub.f32 	%f257, %f321, %f2;
	sub.f32 	%f258, %f320, %f3;
	fma.rn.f32 	%f259, %f255, %f256, %f287;
	fma.rn.f32 	%f260, %f255, %f257, %f288;
	fma.rn.f32 	%f289, %f255, %f258, %f289;
	div.rn.f32 	%f261, %f129, %f147;
	fma.rn.f32 	%f287, %f261, %f321, %f259;
	mul.f32 	%f262, %f261, %f322;
	sub.f32 	%f288, %f260, %f262;
$L__BB0_69:
	setp.eq.s64 	%p64, %rd11, 0;
	@%p64 bra 	$L__BB0_71;
	cvta.to.global.u64 	%rd77, %rd11;
	shl.b64 	%rd78, %rd7, 2;
	add.s64 	%rd79, %rd77, %rd78;
	ld.global.nc.f32 	%f263, [%rd79];
	mul.f32 	%f326, %f326, %f263;
$L__BB0_71:
	ld.param.u64 	%rd88, [adddmibulk_param_2];
	ld.param.u64 	%rd87, [adddmibulk_param_0];
	setp.eq.f32 	%p65, %f326, 0f00000000;
	rcp.rn.f32 	%f264, %f326;
	selp.f32 	%f265, 0f00000000, %f264, %p65;
	cvta.to.global.u64 	%rd80, %rd87;
	shl.b64 	%rd81, %rd7, 2;
	add.s64 	%rd82, %rd80, %rd81;
	ld.global.f32 	%f266, [%rd82];
	fma.rn.f32 	%f267, %f287, %f265, %f266;
	st.global.f32 	[%rd82], %f267;
	cvta.to.global.u64 	%rd83, %rd9;
	add.s64 	%rd84, %rd83, %rd81;
	ld.global.f32 	%f268, [%rd84];
	fma.rn.f32 	%f269, %f288, %f265, %f268;
	st.global.f32 	[%rd84], %f269;
	cvta.to.global.u64 	%rd85, %rd88;
	add.s64 	%rd86, %rd85, %rd81;
	ld.global.f32 	%f270, [%rd86];
	fma.rn.f32 	%f271, %f289, %f265, %f270;
	st.global.f32 	[%rd86], %f271;
$L__BB0_72:
	ret;
