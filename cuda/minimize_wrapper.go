...
var minimize_map = map[int]string{0: "",
	...
	89:  minimize_ptx_89,
	90:  minimize_ptx_90,
	100: minimize_ptx_100,
	120: minimize_ptx_120}
...
.visible .entry minimize(
	.param .u64 .ptr .align 1 minimize_param_0,
	.param .u64 .ptr .align 1 minimize_param_1,
	.param .u64 .ptr .align 1 minimize_param_2,
	.param .u64 .ptr .align 1 minimize_param_3,
	.param .u64 .ptr .align 1 minimize_param_4,
	.param .u64 .ptr .align 1 minimize_param_5,
	.param .u64 .ptr .align 1 minimize_param_6,
	.param .u64 .ptr .align 1 minimize_param_7,
	.param .u64 .ptr .align 1 minimize_param_8,
	.param .f32 minimize_param_9,
	.param .u32 minimize_param_10
)
{
	...
	setp.ge.s32 	%p1, %r1, %r2;
	@%p1 bra 	$L__BB0_2;
	ld.param.u64 	%rd33, [minimize_param_8];
	ld.param.u64 	%rd32, [minimize_param_6];
	ld.param.u64 	%rd31, [minimize_param_5];
	ld.param.u64 	%rd30, [minimize_param_2];
	ld.param.u64 	%rd29, [minimize_param_0];
	cvta.to.global.u64 	%rd10, %rd4;
	...
	add.s64 	%rd23, %rd13, %rd19;
	ld.global.nc.f32 	%f5, [%rd23];
	add.s64 	%rd24, %rd14, %rd19;
	ld.global.nc.f32 	%f6, [%rd24];
	add.s64 	%rd25, %rd15, %rd19;
	ld.global.nc.f32 	%f7, [%rd25];
	mul.f32 	%f8, %f1, %f1;
	mul.f32 	%f9, %f6, %f6;
	fma.rn.f32 	%f10, %f5, %f5, %f9;
	fma.rn.f32 	%f11, %f7, %f7, %f10;
	mul.f32 	%f12, %f8, %f11;
	mov.f32 	%f13, 0f40800000;
	sub.f32 	%f14, %f13, %f12;
	mul.f32 	%f15, %f2, %f14;
	mul.f32 	%f16, %f3, %f14;
	mul.f32 	%f17, %f4, %f14;
	mul.f32 	%f18, %f1, 0f40800000;
	fma.rn.f32 	%f19, %f18, %f5, %f15;
	fma.rn.f32 	%f20, %f18, %f6, %f16;
	fma.rn.f32 	%f21, %f18, %f7, %f17;
	add.f32 	%f22, %f12, 0f40800000;
	div.rn.f32 	%f23, %f19, %f22;
	add.s64 	%rd26, %rd16, %rd19;
	st.global.f32 	[%rd26], %f23;
	div.rn.f32 	%f24, %f20, %f22;
	add.s64 	%rd27, %rd17, %rd19;
