...
var copypadmul2_map = map[int]string{0: "",
	...
	100: copypadmul2_ptx_100,
	120: copypadmul2_ptx_120}
...
.visible .entry copypadmul2(
	.param .u64 .ptr .align 1 copypadmul2_param_0,
	.param .u32 copypadmul2_param_1,
	.param .u32 copypadmul2_param_2,
	.param .u32 copypadmul2_param_3,
	.param .u64 .ptr .align 1 copypadmul2_param_4,
	.param .u32 copypadmul2_param_5,
	.param .u32 copypadmul2_param_6,
	.param .u32 copypadmul2_param_7,
	.param .u64 .ptr .align 1 copypadmul2_param_8,
	.param .f32 copypadmul2_param_9,
	.param .u64 .ptr .align 1 copypadmul2_param_10
)
{
	.reg .pred 	%p<8>;
	.reg .b32 	%r<26>;
	...
	setp.ge.s32 	%p1, %r1, %r7;
	setp.ge.s32 	%p2, %r18, %r9;
	or.pred  	%p3, %p1, %p2;
	setp.ge.s32 	%p4, %r22, %r10;
	or.pred  	%p5, %p3, %p4;
	@%p5 bra 	$L__BB0_6;
	mad.lo.s32 	%r23, %r9, %r22, %r18;
	mad.lo.s32 	%r4, %r23, %r7, %r1;
	setp.eq.s64 	%p6, %rd3, 0;
	@%p6 bra 	$L__BB0_3;
	cvta.to.global.u64 	%rd5, %rd3;
	mul.wide.s32 	%rd6, %r4, 4;
