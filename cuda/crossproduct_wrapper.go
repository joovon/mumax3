...
var crossproduct_map = map[int]string{0: "",
	...
	100: crossproduct_ptx_100,
	120: crossproduct_ptx_120}
...
.visible .entry crossproduct(
	.param .u64 .ptr .align 1 crossproduct_param_0,
	.param .u64 .ptr .align 1 crossproduct_param_1,
	.param .u64 .ptr .align 1 crossproduct_param_2,
	.param .u64 .ptr .align 1 crossproduct_param_3,
	.param .u64 .ptr .align 1 crossproduct_param_4,
	.param .u64 .ptr .align 1 crossproduct_param_5,
	.param .u64 .ptr .align 1 crossproduct_param_6,
	.param .u64 .ptr .align 1 crossproduct_param_7,
	.param .u64 .ptr .align 1 crossproduct_param_8,
	.param .u32 crossproduct_param_9
)
{
	.reg .pred 	%p<2>;
	...
	setp.ge.s32 	%p1, %r1, %r2;
	@%p1 bra 	$L__BB0_2;
	ld.param.u64 	%rd32, [crossproduct_param_6];
	ld.param.u64 	%rd31, [crossproduct_param_5];
	ld.param.u64 	%rd30, [crossproduct_param_2];
	ld.param.u64 	%rd29, [crossproduct_param_0];
	cvta.to.global.u64 	%rd10, %rd4;
