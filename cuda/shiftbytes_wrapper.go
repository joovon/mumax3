...
var shiftbytes_map = map[int]string{0: "",
	...
	100: shiftbytes_ptx_100,
	120: shiftbytes_ptx_120}
...
.visible .entry shiftbytes(
	.param .u64 .ptr .align 1 shiftbytes_param_0,
	.param .u64 .ptr .align 1 shiftbytes_param_1,
	.param .u32 shiftbytes_param_2,
	.param .u32 shiftbytes_param_3,
	.param .u32 shiftbytes_param_4,
	.param .u32 shiftbytes_param_5,
...
)
{
	...
	ld.param.u64 	%rd1, [shiftbytes_param_0];
	ld.param.u64 	%rd2, [shiftbytes_param_1];
	ld.param.u32 	%r5, [shiftbytes_param_2];
	ld.param.u32 	%r8, [shiftbytes_param_3];
	ld.param.u32 	%r9, [shiftbytes_param_4];
	ld.param.u32 	%r7, [shiftbytes_param_5];
	ld.param.u8 	%rs5, [shiftbytes_param_6];
	mov.u32 	%r11, %ctaid.x;
	mov.u32 	%r12, %ntid.x;
	mov.u32 	%r13, %tid.x;
