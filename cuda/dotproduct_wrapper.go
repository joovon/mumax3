...
var dotproduct_map = map[int]string{0: "",
	...
	100: dotproduct_ptx_100,
	120: dotproduct_ptx_120}
...
.visible .entry dotproduct(
	.param .u64 .ptr .align 1 dotproduct_param_0,
	.param .f32 dotproduct_param_1,
	.param .u64 .ptr .align 1 dotproduct_param_2,
	.param .u64 .ptr .align 1 dotproduct_param_3,
	.param .u64 .ptr .align 1 dotproduct_param_4,
	.param .u64 .ptr .align 1 dotproduct_param_5,
	.param .u64 .ptr .align 1 dotproduct_param_6,
	.param .u64 .ptr .align 1 dotproduct_param_7,
	.param .u32 dotproduct_param_8
)
{
	.reg .pred 	%p<2>;
	...
	setp.ge.s32 	%p1, %r1, %r2;
	@%p1 bra 	$L__BB0_2;
	ld.param.u64 	%rd23, [dotproduct_param_0];
	cvta.to.global.u64 	%rd8, %rd2;
