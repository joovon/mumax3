...
var reducemaxvecnorm2_map = map[int]string{0: "",
	...
	100: reducemaxvecnorm2_ptx_100,
	120: reducemaxvecnorm2_ptx_120}
...
.visible .entry reducemaxvecnorm2(
	.param .u64 .ptr .align 1 reducemaxvecnorm2_param_0,
	.param .u64 .ptr .align 1 reducemaxvecnorm2_param_1,
	.param .u64 .ptr .align 1 reducemaxvecnorm2_param_2,
	.param .u64 .ptr .align 1 reducemaxvecnorm2_param_3,
	.param .f32 reducemaxvecnorm2_param_4,
	.param .u32 reducemaxvecnorm2_param_5
)
{
...
$L__BB0_7:
	shl.b32 	%r32, %r1, 2;
	mov.u32 	%r33, _ZZ17reducemaxvecnorm2E5sdata;
	add.s32 	%r14, %r33, %r32;
	st.shared.f32 	[%r14], %f70;
	bar.sync 	0;
...
$L__BB0_11:
	...
	ld.volatile.shared.f32 	%f50, [%r14+64];
	max.f32 	%f51, %f49, %f50;
	st.volatile.shared.f32 	[%r14], %f51;
	ld.volatile.shared.f32 	%f52, [%r14];
	ld.volatile.shared.f32 	%f53, [%r14+32];
	max.f32 	%f54, %f52, %f53;
	st.volatile.shared.f32 	[%r14], %f54;
	ld.volatile.shared.f32 	%f55, [%r14];
	ld.volatile.shared.f32 	%f56, [%r14+16];
	max.f32 	%f57, %f55, %f56;
	st.volatile.shared.f32 	[%r14], %f57;
	ld.volatile.shared.f32 	%f58, [%r14];
	ld.volatile.shared.f32 	%f59, [%r14+8];
	max.f32 	%f60, %f58, %f59;
	st.volatile.shared.f32 	[%r14], %f60;
	ld.volatile.shared.f32 	%f61, [%r14];
	ld.volatile.shared.f32 	%f62, [%r14+4];
	max.f32 	%f63, %f61, %f62;
	st.volatile.shared.f32 	[%r14], %f63;
	...
	atom.global.max.s32 	%r37, [%rd26], %r36;
$L__BB0_14:
	ret;

}
`
	reducemaxvecnorm2_ptx_120 = `
.version 8.8
.target sm_120
.address_size 64
