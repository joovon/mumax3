...
var adduniaxialanisotropy2_map = map[int]string{0: "",
	...
	86:  adduniaxialanisotropy2_ptx_86,
	87:  adduniaxialanisotropy2_ptx_87,
	89:  adduniaxialanisotropy2_ptx_89,
	90:  adduniaxialanisotropy2_ptx_90,
	100: adduniaxialanisotropy2_ptx_100,
	120: adduniaxialanisotropy2_ptx_120}
...
`
	adduniaxialanisotropy2_ptx_100 = `
.version 8.8
.target sm_100
.address_size 64
...
.visible .entry adduniaxialanisotropy2(
	.param .u64 .ptr .align 1 adduniaxialanisotropy2_param_0,
	.param .u64 .ptr .align 1 adduniaxialanisotropy2_param_1,
	.param .u64 .ptr .align 1 adduniaxialanisotropy2_param_2,
	.param .u64 .ptr .align 1 adduniaxialanisotropy2_param_3,
	.param .u64 .ptr .align 1 adduniaxialanisotropy2_param_4,
	.param .u64 .ptr .align 1 adduniaxialanisotropy2_param_5,
	.param .u64 .ptr .align 1 adduniaxialanisotropy2_param_6,
	.param .f32 adduniaxialanisotropy2_param_7,
	.param .u64 .ptr .align 1 adduniaxialanisotropy2_param_8,
	.param .f32 adduniaxialanisotropy2_param_9,
	.param .u64 .ptr .align 1 adduniaxialanisotropy2_param_10,
	.param .f32 adduniaxialanisotropy2_param_11,
	.param .u64 .ptr .align 1 adduniaxialanisotropy2_param_12,
	.param .f32 adduniaxialanisotropy2_param_13,
	.param .u64 .ptr .align 1 adduniaxialanisotropy2_param_14,
	.param .f32 adduniaxialanisotropy2_param_15,
	.param .u64 .ptr .align 1 adduniaxialanisotropy2_param_16,
	.param .f32 adduniaxialanisotropy2_param_17,
	.param .u32 adduniaxialanisotropy2_param_18
)
{
	...
	ld.param.u64 	%rd5, [adduniaxialanisotropy2_param_4];
	ld.param.u64 	%rd7, [adduniaxialanisotropy2_param_6];
	ld.param.f32 	%f65, [adduniaxialanisotropy2_param_7];
	ld.param.u64 	%rd8, [adduniaxialanisotropy2_param_8];
	ld.param.f32 	%f66, [adduniaxialanisotropy2_param_9];
	ld.param.u64 	%rd9, [adduniaxialanisotropy2_param_10];
	ld.param.f32 	%f67, [adduniaxialanisotropy2_param_11];
	ld.param.u64 	%rd10, [adduniaxialanisotropy2_param_12];
	ld.param.f32 	%f62, [adduniaxialanisotropy2_param_13];
	ld.param.u64 	%rd11, [adduniaxialanisotropy2_param_14];
	ld.param.f32 	%f63, [adduniaxialanisotropy2_param_15];
	ld.param.u64 	%rd12, [adduniaxialanisotropy2_param_16];
	ld.param.f32 	%f64, [adduniaxialanisotropy2_param_17];
	ld.param.u32 	%r2, [adduniaxialanisotropy2_param_18];
	mov.u32 	%r3, %ctaid.y;
	mov.u32 	%r4, %nctaid.x;
	mov.u32 	%r5, %ctaid.x;
...
$L__BB0_7:
	mul.f32 	%f25, %f63, %f63;
	fma.rn.f32 	%f26, %f62, %f62, %f25;
	fma.rn.f32 	%f27, %f64, %f64, %f26;
	sqrt.rn.f32 	%f28, %f27;
	setp.neu.f32 	%p5, %f28, 0f00000000;
	rcp.rn.f32 	%f29, %f28;
	selp.f32 	%f30, %f29, 0f00000000, %p5;
	mul.f32 	%f7, %f62, %f30;
	mul.f32 	%f8, %f63, %f30;
	mul.f32 	%f9, %f64, %f30;
	setp.eq.s64 	%p6, %rd7, 0;
...
$L__BB0_11:
	...
	mul.f32 	%f67, %f67, %f33;
$L__BB0_13:
	ld.param.u64 	%rd46, [adduniaxialanisotropy2_param_5];
	ld.param.u64 	%rd45, [adduniaxialanisotropy2_param_2];
	ld.param.u64 	%rd44, [adduniaxialanisotropy2_param_0];
	rcp.rn.f32 	%f34, %f65;
	setp.eq.f32 	%p9, %f65, 0f00000000;
	selp.f32 	%f35, 0f00000000, %f34, %p9;
	mul.f32 	%f36, %f35, %f67;
	cvta.to.global.u64 	%rd31, %rd4;
	mul.wide.s32 	%rd32, %r1, 4;
	add.s64 	%rd33, %rd31, %rd32;
	...
	cvta.to.global.u64 	%rd36, %rd46;
	add.s64 	%rd37, %rd36, %rd32;
	ld.global.nc.f32 	%f39, [%rd37];
	mul.f32 	%f40, %f8, %f38;
	fma.rn.f32 	%f41, %f7, %f37, %f40;
	fma.rn.f32 	%f42, %f9, %f39, %f41;
	mul.f32 	%f43, %f35, %f66;
	fma.rn.f32 	%f44, %f35, %f66, %f43;
	mul.f32 	%f45, %f44, %f42;
	mul.f32 	%f46, %f36, 0f40800000;
	mul.f32 	%f47, %f42, %f42;
	mul.f32 	%f48, %f42, %f47;
	mul.f32 	%f49, %f46, %f48;
	mul.f32 	%f50, %f7, %f49;
	mul.f32 	%f51, %f8, %f49;
	mul.f32 	%f52, %f9, %f49;
	fma.rn.f32 	%f53, %f7, %f45, %f50;
	fma.rn.f32 	%f54, %f8, %f45, %f51;
	fma.rn.f32 	%f55, %f9, %f45, %f52;
	cvta.to.global.u64 	%rd38, %rd44;
	add.s64 	%rd39, %rd38, %rd32;
	ld.global.f32 	%f56, [%rd39];
	add.f32 	%f57, %f56, %f53;
	st.global.f32 	[%rd39], %f57;
	cvta.to.global.u64 	%rd40, %rd2;
	add.s64 	%rd41, %rd40, %rd32;
	ld.global.f32 	%f58, [%rd41];
	add.f32 	%f59, %f58, %f54;
	st.global.f32 	[%rd41], %f59;
...
`
	adduniaxialanisotropy2_ptx_120 = `
.version 8.8
.target sm_120
.address_size 64
