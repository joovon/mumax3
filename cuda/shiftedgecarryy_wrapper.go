...
var shiftedgecarryY_map = map[int]string{0: "",
	...
	100: shiftedgecarryY_ptx_100,
	120: shiftedgecarryY_ptx_120}
...
.visible .entry shiftedgecarryY(
	.param .u64 .ptr .align 1 shiftedgecarryY_param_0,
	.param .u64 .ptr .align 1 shiftedgecarryY_param_1,
	.param .u64 .ptr .align 1 shiftedgecarryY_param_2,
	.param .u64 .ptr .align 1 shiftedgecarryY_param_3,
	.param .u32 shiftedgecarryY_param_4,
	.param .u32 shiftedgecarryY_param_5,
	.param .u32 shiftedgecarryY_param_6,
	.param .u32 shiftedgecarryY_param_7,
...
)
{
	...
	ld.param.u64 	%rd8, [shiftedgecarryY_param_2];
	ld.param.u64 	%rd9, [shiftedgecarryY_param_3];
	ld.param.u32 	%r5, [shiftedgecarryY_param_4];
	ld.param.u32 	%r8, [shiftedgecarryY_param_5];
	ld.param.u32 	%r9, [shiftedgecarryY_param_6];
	ld.param.u32 	%r7, [shiftedgecarryY_param_7];
	ld.param.f32 	%f7, [shiftedgecarryY_param_8];
	ld.param.f32 	%f8, [shiftedgecarryY_param_9];
	cvta.to.global.u64 	%rd1, %rd9;
	cvta.to.global.u64 	%rd2, %rd8;
...
$L__BB0_5:
	...
	bra.uni 	$L__BB0_10;
$L__BB0_9:
	mad.lo.s32 	%r25, %r8, %r21, %r4;
	mad.lo.s32 	%r26, %r25, %r5, %r1;
	mul.wide.s32 	%rd16, %r26, 4;
	add.s64 	%rd17, %rd3, %rd16;
	ld.global.nc.f32 	%f13, [%rd17];
$L__BB0_10:
	mad.lo.s32 	%r29, %r8, %r21, %r17;
	mad.lo.s32 	%r30, %r29, %r5, %r1;
	cvta.to.global.u64 	%rd24, %rd6;
